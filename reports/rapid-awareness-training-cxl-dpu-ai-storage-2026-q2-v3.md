# Rapid Awareness Training: CXL, DPU Offload, and AI/HPC Storage for Project Coherent Storage v3
...
| CXL role | Allowed in v3 | Required evidence |
| --- | --- | --- |
...
This report is derived from the v3 package RAG manifests and the new v3 arXiv addendum. See `README.md`, `latex/references.bib`, and `research/arxiv-cxl-dpu-storage-metadata-2026-05-15.md`.
