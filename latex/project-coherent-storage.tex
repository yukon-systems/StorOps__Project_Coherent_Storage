...
\end{figure}
\section{Conclusion}
The architecture separates scale-up, scale-out, storage, management, timing, and memory-pool planes while preserving Coherence-CE as the actor-visible contract. UA-Link, CXL, RoCEv2, DPU offload, and heterogeneous GPUs become governed resources with explicit evidence and admission gates.
